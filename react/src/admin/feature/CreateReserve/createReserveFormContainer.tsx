...
} from "@/admin/api/Reserve/createReserve";
...
export const useCreateReserveForm = () => {
  const {
    register: CreateReserveData,
    handleSubmit,
    formState: { errors },
  } = useForm<useCreateReserveSchema>({
    resolver: zodResolver(schema),
  });
  const { mutate, isLoading } = useCreateReserveMutation();
  ...
  return { CreateReserveData, handleSubmit, onSubmit, errors, isLoading };
};
